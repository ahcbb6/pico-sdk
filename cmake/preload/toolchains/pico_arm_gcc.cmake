...
message("CFLAGS1: ${ARM_TOOLCHAIN_COMMON_FLAGS}")
message("TO: $ENV{TOOLCHAIN_OPTIONS}")
message("TO2: ${TOOLCHAIN_OPTIONS}")
...
if (NOT PICO_GCC_TRIPLE)
    if (DEFINED ENV{PICO_GCC_TRIPLE})
      ...
      # set(PICO_GCC_TRIPLE arm-none-eabi)
        message("PICO_GCC_TRIPLE defaulted to arm-poky-eabi")
    endif()
endif()
...
# set(ARM_TOOLCHAIN_COMMON_FLAGS " -mcpu=cortex-m0plus -mthumb $ENV{TOOLCHAIN_OPTIONS}")
set(ARM_TOOLCHAIN_COMMON_FLAGS " -mcpu=cortex-m0plus -mthumb ${TOOLCHAIN_OPTIONS}")
message("ARMTC: ${ARM_TOOLCHAIN_COMMON_FLAGS}")
